...
namespace Tweaker.Optimizations
{
    ...
    public static class GpuOptimization
    {
        ...
        /// <summary>
        /// OPTIMIZACI�N CR�TICA: System Profile Games Priority
        /// 
        /// GPU Priority: 8 (M�ximo = 8)
        ...
        ///   - Valores mayores = m�s tiempo de CPU dedicado al juego
        ///   - Reduce latencia del sistema (system latency)
        /// 
        /// Scheduling Category: "High"
        ///   - Categor�a de programaci�n del Task Scheduler de Windows
        ///   - "High" asegura que el juego se ejecute antes que procesos de fondo
        ///   - Mejora consistencia de FPS y reduce input lag
        /// 
        /// IMPACTO EN ESPORTS:
        /// - Reduce input lag en 3-8ms (cr�tico en shooters)
        /// - Mejora 1% y 0.1% low FPS (frame times m�s estables)
        ...
        /// 
        /// �Qu� es GameDVR?
        /// - Sistema de grabaci�n en background de Windows 10/11
        /// - Captura gameplay autom�ticamente (Game Bar overlay)
        ...
        public static bool DisableGameDVR()
        {
            try
            {
                ...
                // Deshabilitar captures autom�ticas
        ...
        /// 
        /// ¿Qué es MPO?
        /// - Una característica de Windows que permite a la GPU mostrar múltiples capas de imagen.
        /// - PROBLEMA: Causa flickering, stuttering y pantallazos negros en navegadores y juegos.
        /// - Solución estándar recomendada por NVIDIA y AMD para problemas de estabilidad.
        /// </summary>
        ...
        /// <summary>
        /// Verifica si GPU Scheduling est� habilitado
        /// </summary>
